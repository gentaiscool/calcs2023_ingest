 ...
 \renewcommand{\headrulewidth}{0pt}
  \AddToShipoutPicture*{
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 1--13 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{TongueSwitcher: Fine-Grained Identification of German-English Code-Switching},ref:paper_{2}}]{examples/calcs/papers/paper2.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 14--22 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Towards Real-World Streaming Speech Translation for Code-Switched Speech},ref:paper_{3}}]{examples/calcs/papers/paper3.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 23--32 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Language Preference for Expression of Sentiment for Nepali-English Bilingual Speakers on Social Media},ref:paper_{4}}]{examples/calcs/papers/paper4.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 33--42 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Text-Derived Language Identity Incorporation for End-to-End Code-Switching Speech Recognition},ref:paper_{5}}]{examples/calcs/papers/paper5.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
  ...
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Prompting Multilingual Large Language Models to Generate Code-Mixed Texts: The Case of South East Asian Languages},ref:paper_{6}}]{examples/calcs/papers/paper6.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 64--73 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{CONFLATOR: Incorporating Switching Point based Rotatory Positional Encodings for Code-Mixed Language Modeling},ref:paper_{10}}]{examples/calcs/papers/paper10.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
    ...
    \put(0,13){\parbox[t]{\paperwidth}{\centering
    							\emph{Proceedings of the 6th Workshop on Computational Approaches to Linguistic Code-Switching}, pages 74--82 \\
  	  						December 7, 2023 \textcopyright
  							2023 Association for Computational Linguistics}}
  }
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Unified Model for Code-Switching Speech Recognition and Language Identification Based on Concatenated Tokenizer},ref:paper_{18}}]{examples/calcs/papers/paper18.pdf}
  \AddToShipoutPicture*{
    \setlength{\unitlength}{1mm}
    \footnotesize
  ...
  \includepdf[pagecommand={\thispagestyle{plain}},pages=-,addtotoc={1,section,1,{Multilingual self-supervised speech representations improve the speech recognition of low-resource African languages with codeswitching},ref:paper_{20}}]{examples/calcs/papers/paper20.pdf}
